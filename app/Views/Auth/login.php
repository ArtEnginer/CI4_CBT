        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    <div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img class="logo-icon me-2" src="<?= base_url('assets/portal') ?>/images/app-logo.svg" alt="logo"></a></div>
                    ...
                    <div class="auth-form-container text-start">
                        ...
                        <form action="<?= url_to('login') ?>" method="post" class="auth-form login-form">
                            ...
                            <div class="email mb-3">
                                <label class="sr-only" for="login">NIDN/NIM</label>
                                <input id="login" name="login" type="text" class="form-control signin-email <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="NIDN/NIM" required="required">
                            ...
                            <div class="password mb-3">
                                ...
                                <input id="password" name="password" type="password" class="form-control signin-password <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.password') ?>" required="required">
                                <div class="invalid-feedback">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto"><?= lang('Auth.loginAction') ?></button>
                            </div>
                        </form>

                        <?php if ($config->allowRegistration) : ?>
                            <div class="auth-option text-center pt-5"><?= lang('Auth.needAnAccount') ?> ? <a class="text-link" href="<?= url_to('register') ?>">Daftar</a>.</div>
                        <?php endif; ?>
                    </div>
